...
export default function CTA() {
  return (
    <section className="py-20 bg-gradient-to-br from-[#0a1628] to-[#1a365d] text-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-6">
          The Protocols Are Live.<br />
          <span className="text-[#60a5fa]">Is Your Architecture Ready?</span>
        </h2>
        <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
          Google UCP and OpenAI ACP are processing transactions now. Don't let legacy architecture render you invisible to AI agents.
        </p>
