...
const TechnicalFrameworkCTA = () => {
  const buttonColor = `text-gray-800`;
  const borderColor = `border-gray-900`;

  return (
    <section
      className={`bg-gradient-to-r from-slate-600 70% to-gray-600 py-20 mt-20 w-full 
      flex flex-col items-center justify-center gap-10 px-4`}
    >
      <h5 className="text-3xl md:text-4xl font-bold text-white text-center">
    Ready to Achieve Technical Excellence?
      </h5>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-5 w-full">
        ...
        <Link href="/authority-hub" className="w-full sm:w-auto">
          ...
          >
            <span>Explore More Frameworks</span>
            <BookOpen />
          </button>
        </Link>
      </div>
...
export default TechnicalFrameworkCTA