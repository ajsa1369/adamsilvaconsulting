    ...
    ">
      ...
      <div className="text-center mb-6">
        <h1 className="text-4xl md:text-6xl font-bold tracking-tight leading-tight">
          ...
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-amber-500">Content Operations</span>
        </h1>
      </div>

      {/* Subheading */}
      <h2 className="text-xl md:text-2xl text-blue-100 mb-6 text-center max-w-4xl">
      ...
      <div className="flex flex-wrap justify-center gap-4">
        <Link href="/contact" className="
          bg-gradient-to-r from-orange-500 to bg-orange-700 hover:bg-orange-600 
